...
namespace Pract4
{
    class Program
    {
        ...
        /// </summary>
        static readonly int timeSlotDefault = 200;
        /// <summary>
        ...
        static void GoTimer(int ticks)
        {
            var timer = Stopwatch.StartNew();
            do
            {
            } while (timer.ElapsedTicks < ticks);
            timer.Stop();
        }
        ...
        static void ChangeTimeSlot()
        {
            ...
            {
                Console.WriteLine("Введите номер потока, для которого хотите увеличить квант времени на 15 тиков (максимальный квант 255).");
        ...
        static void Main(string[] args)
        {
            ...
            //process.StartInfo.FileName = @"C:\Program Files (x86)\Microsoft Office\root\Office16\WINWORD.EXE";
            //process.Start();
